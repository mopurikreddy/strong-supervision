...
require 'densecap.DenseCapModel_imagenet'
...
-- Output settings
cmd:option('-max_images', 10000, 'max number of images to process')
cmd:option('-output_dir', './output-pics')
    ...
    cmd:option('-box_width', 3, 'width of rendered box')
...
function run_image(model, img_path, opt, dtype)
  ...
  print('run_the_model/forward_test')
